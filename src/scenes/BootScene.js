...
class BootScene extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.audio('albundy', [
            'assets/music/albundy.mp3'
        ]);
        this.load.audio('mwctheme', [
            'assets/music/marriedwithchildrentheme.ogg',
            'assets/music/marriedwithchildrentheme.mp3'
        ]);
